	...
	function getExportable($contextId, $pubIdType = null, $title = null, $author = null, $issueId = null, $pubIdSettingName = null, $pubIdSettingValue = null, $rangeInfo = null) {
		...
		$result = $this->retrieveRange(
			...
			FROM	submission_galleys g
				...
				LEFT JOIN author_settings asl ON (asl.author_id = u.author_id AND asl.setting_name = \''.AUTHOR_FIELD_LASTNAME.'\' AND asl.locale = \''.AppLocale::getLocale().'\')
				LEFT JOIN author_settings asf ON (asf.author_id = u.author_id AND asf.setting_name = \''.AUTHOR_FIELD_FIRSTNAME.'\' AND asf.locale = \''.AppLocale::getLocale().'\' )
				LEFT JOIN author_settings asm ON (asm.author_id = u.author_id AND asm.setting_name = \''.AUTHOR_FIELD_MIDDLENAME.'\' AND asm.locale = \''.AppLocale::getLocale().'\' )
